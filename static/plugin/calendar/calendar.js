            ...
            if(walk) {
                ...
                if (opts.autoHide) {
                    $(document).on('click', function (event) {
                        ...
                        if (!$.contains(kalend.$wrap.get(0), $that.get(0))) {

                            kalend.nowTime = JSON.parse(JSON.stringify(kalend.initTime));
                            kalend.$wrap.hide();
                            creat = false;
                        }
                    });
                ...
                kalend.confirmBtnHandle(opts.type, function(time){
                    opts.changeTimeFn && opts.changeTimeFn($this, time);
                    creat = false;
                });
                ...
                kalend.cancelBtnHandle(opts.type, function ($this, time){
                    creat = false;
                });
